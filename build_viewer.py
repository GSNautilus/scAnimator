...
EXAMPLES
  ...
  python build_viewer.py --input pbmc3k.h5ad --output-dir viewer/datasets/pbmc3k \\
      --sweep 5-150-11

  # Large dataset, static UMAP, HVGs only
  python build_viewer.py --input organoid.h5ad --output-dir viewer/datasets/organoid \\
  ...
  python build_viewer.py --export-dir ./export --output-dir viewer/datasets/neural
