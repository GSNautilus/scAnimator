"""
update_dataset_index.py -- Scan viewer/datasets/ and write datasets/index.json.
================================================================================

The landing page (viewer/index.html) reads datasets/index.json to discover
available datasets. This script scans for subdirectories that contain a
metadata.json file and writes the index.

Usage:
  python update_dataset_index.py
  python update_dataset_index.py --datasets-dir /path/to/viewer/datasets
"""
...
parser.add_argument("--datasets-dir",
                    default=os.path.join(os.path.dirname(__file__), "viewer", "datasets"),
                    help="Path to viewer/datasets/ directory")
